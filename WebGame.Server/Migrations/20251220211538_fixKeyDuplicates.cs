...
{
    /// <inheritdoc />
    public partial class fixKeyDuplicates : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AddPrimaryKey(
                name: "PK_MapBuildings",
                table: "MapBuildings",
                columns: new[] { "MapId", "TopLeftX", "TopLeftY" });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AddPrimaryKey(
                name: "PK_MapTiles",
                table: "MapTiles",
                columns: new[] { "TileId", "MapId" });

            migrationBuilder.AddPrimaryKey(
                name: "PK_MapBuildings",
                table: "MapBuildings",
                columns: new[] { "BuildingId", "MapId" });
