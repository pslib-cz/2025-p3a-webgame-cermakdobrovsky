      ...
      <div className="menu__container">
        ...
        <div className="menu__container-goal" ref={goalRef}>
          <p className="menu__container-goal-description">
            Cíl hry je dosáhnout 10. úrovně vesnice za co nejkratší čas. Čím více stavíš, tím vyšší máš populaci a tím více potřebuješ ovcí. Jenže čím více plochy je zastavěno, tím méně mají ovce místa a nemůžeš jich mít tolik. Když budeš mít víc populace než ovcí, tak ti ovce začnou umírat.
          </p>
        </div>
