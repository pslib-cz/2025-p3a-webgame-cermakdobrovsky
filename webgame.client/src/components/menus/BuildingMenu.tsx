...
const BuildingMenu: FC<BuildingMenuProps> = ({ isOpen, building, setIsOpen, onDeleteBuilding }) => {
  return (
    <div className="building-menu" style={{ display: isOpen ? "block" : "none" }}>
      <div className="building-menu__wrapper">
        ...
        <div className="building-menu__upgrade-section">
          ...
          <Button className="building-menu__upgrade-button" onClick={() => setIsOpen(false)}>
            Vylepšit
          </Button>
        </div>
        {!building.isTownHall && (
